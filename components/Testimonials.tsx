...
export default async function Testimonials() {
  ...
  return (
    <section className="testimonials section" id="testimonials">
      ...
      <div className="absolute w-full bg-container left-0 -bottom-16 pb-16 border-b border-primary">
        ...
        <div className="section-data container section-container grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="box text-center p-6">
            ...
            {/*Title */}
            <h3 className="section-title font-montserrat text-start sm:text-center">{TEXT.testimonilasTitle1}<br/>{TEXT.testimonilasTitle2}</h3>
            <p className="text-base text-muted-foreground text-start sm:text-center mb-5">{TEXT.testimonilasDescription1}</p>
